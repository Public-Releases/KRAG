...
#SBATCH --output=output/baseline_RAG_openbiollm-8b.%j.out    # Output file
#SBATCH --error=output/baseline_RAG_openbiollm-8b.%j.err     # Error file
...
python run_ablation.py --mode rag_only --max_samples 100 --model local/openbiollm-8b
